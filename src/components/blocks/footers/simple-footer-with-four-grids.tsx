...
export function SimpleFooterWithFourGrids() {
  ...
  return (
    <div className="border-t border-neutral-100 dark:border-white/[0.1] px-4 sm:px-8 py-12 sm:py-16 md:py-20 bg-neutral-950 w-full relative overflow-hidden max-w-full">
      <div className="max-w-7xl mx-auto text-sm text-neutral-300 flex flex-col sm:flex-row justify-between items-start md:px-8 w-full">
        <div className="w-full sm:w-auto mb-8 sm:mb-0">
          <div className="mr-0 md:mr-4 md:flex mb-4">
            <Logo />
          </div>

          <div className="mt-2 ml-2 text-neutral-400 max-w-xs text-xs sm:text-sm">
            Proof-of-Concept Android Application for Image Verification
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10 items-start w-full sm:w-auto">
          <div className="flex justify-center sm:justify-start space-y-3 sm:space-y-4 flex-col w-full">
            <p className="transition-colors text-white font-bold text-sm sm:text-base">
              Technology
            </p>
            <ul className="transition-colors text-neutral-400 list-none space-y-3 sm:space-y-4">
