...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-6 z-50 px-6">
      <nav aria-label="Global" className="mx-auto max-w-7xl">
        <div className="flex items-center justify-between p-4 lg:px-8 bg-white/80 backdrop-blur-md rounded-full shadow-lg border border-white/30 transition-all duration-300">
